var ws = {
	...
	randLetter: function() {
		var letters = new Array("А", "Б", "В", "Г", "Ґ", "Д", "Е", "Є", "Ж", "З", "И", "І", "Й", "Ї", "К", "Л", "М", "Н", "О", "П", "Р", "С", "Т", "У", "Ф", "Х", "Ц", "Ч", "Ш", "Щ", "Ь", "Ю", "Я");
...
$(document).ready(function() {
	...
	$("#btn_reload").hover(
		function() { this.src = this.src.replace("img/reload1.html", "img/reload0.html"); },
		function() { this.src = this.src.replace("img/reload0.html", "img/reload1.html"); }
	);
	$("#btn_printable").hover(
